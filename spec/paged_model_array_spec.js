...
describe('Z.PagedModelArray', function() {
  ...
  describe('.find', function() {
    ...
    it('should invoke the `findPage` method with page 0', function() {
      array.find();
      expect(array.findPage).toHaveBeenCalledWith(0);
    });

    it('should invoke the `findPage` method with the given page option', function() {
      array.find({page: 12});
      expect(array.findPage).toHaveBeenCalledWith(12);
    });
  });
