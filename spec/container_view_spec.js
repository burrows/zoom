...
describe('Z.ContainerView.init with a `contentView` property that is not a `Z.View` instance', function() {
...
describe('Z.ContainerView.init with a `contentView` property', function() {
...
describe('Z.ContainerView.init with a `nowShowing` property that is not a Z.View', function() {
  it('should throw an exception', function() {
    var o = Z.Object.create();
...
describe('Z.ContainerView.init with a string `nowShowing` property', function() {
...
describe('Z.ContainerView.init with a Z.View `nowShowing` property', function() {
...
describe('Z.ContainerView: changing the `contentView` property', function() {
  ...
  it('should not destroy the previous subview when `destroyOnRemove` is `false`', function() {
    var tv1 = TestView1.create(),
        tv2 = TestView2.create(),
        cv  = Z.ContainerView.create({contentView: tv1, destroyOnRemove: false});

    spyOn(tv1, 'destroy');
    cv.contentView(tv2);
    expect(tv1.destroy).not.toHaveBeenCalled();
  });
...
describe('Z.ContainerView: changing the `nowShowing` property', function() {
  var tv1, cv;
